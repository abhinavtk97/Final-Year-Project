...
####################################
  ...
  for display_str in display_str_list[::-1]:
    ...
    r = 10
    bbox =  (im_width/2 - r/2, im_height/2 - r/2, im_width/2 + r/2, im_height/2 + r/2)
    bbox1 = ((left+right)/2-r/2,(bottom+top)/2-r/2,(left+right)/2+r/2,(top+bottom)/2+r/2)
    ...
    draw.rectangle(
        [(left, text_bottom - text_height - 2 * margin), (left + text_width,
                                                          text_bottom)],
        fill=color)
    print("Xoffset: ",((im_width/2)-(left+right)/2),"\tYoffset: ",((im_height/2)-(top+bottom)/2))
    draw.ellipse(bbox, fill=128)
    draw.ellipse(bbox1, fill=(0,255,0,255))
    draw.line((im_width/2,im_height/2, (left+right)/2,(top+bottom)/2), fill=(0,0,255,255))
    draw.text(
    ...
    draw.text(
        ...
        ("Yoffset: ",((im_width/2)-(left+right)/2),"\tXoffset: ",((im_height/2)-(top+bottom)/2)),
        fill='black',
        font=font)
